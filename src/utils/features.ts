...
export const translateWords = async (params: LangType): Promise<WordType[]> => {
  try {
    ...
    const microsoftKey = import.meta.env.VITE_Microsoft;
...
//1ffe809cf21f465f88b67d770eb04a89

export const FetchAudio = async (
  text: string,
  language: LangType
): Promise<string> => {
  const textToSpeech = import.meta.env.VITE_TextToSpeech;
  const rapidKey = import.meta.env.VITE_RapidKey;
